...
:- http_handler(css('bootstrap.min.css'),  http_reply_file('bootstrap.min.css', []), []).
:- http_handler(css('signin.css'), http_reply_file('signin.css', []), []).
...
search_form -->
	...
	html([ \html_requires(css('bootstrap.min.css')),
